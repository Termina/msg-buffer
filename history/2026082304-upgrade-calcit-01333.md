...
- Bumped the module version to 0.0.2 for the next stable release.
- Pinned setup-calcit to `v1.3.0` and requested the current `calcit,caps` tools.
- Revalidated the canonical `calcit.cirru` snapshot, quality baseline, and JavaScript build path.
